...
/**
 * 	Carga un mapa de Tiled  y lo añade al stage.
...
public class TilemapActor extends Actor {
    ...
    /**
     * 	Carga un mapa de Tiled (*.tmx) y lo añade al stage.
     */
    public TilemapActor(String filename, Stage theStage) {
        ...
        tiledCamera.setToOrtho(false, windowWidth /3 , windowHeight /3);
        tiledCamera.update();
    ...
    /**
     * 	Busca por las capas de objetos del mapa a los objetos rectangulares por una propuedad llamada "name".
     * 	Se usa para guardar la informacion de no-actores tales como los spawns o las dimensiones de objetos solidos.
	*/
